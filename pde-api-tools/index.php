	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
		  <h2><b>Current Development</b></h2>
		  	...
		  	<ol>
		  		<li><a href="./apiusage/sdk_html.zip" target="_blank">Example HTML report of the SDK</a>. You can also review the report on the web <a href="./apiusage/sdk_html/index.php">here</a>.</li>
